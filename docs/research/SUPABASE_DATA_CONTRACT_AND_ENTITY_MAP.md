...
> This legacy document contained unenforceable polymorphic foreign keys and Supabase-specific configurations. It has been formally superseded by [`TAT_RESEARCH_CONTRACT_V1_1_2.md`](./TAT_RESEARCH_CONTRACT_V1_1_2.md); current implementation proposals belong under `docs/engineering/`.

This document provides historical entity inventory context.
